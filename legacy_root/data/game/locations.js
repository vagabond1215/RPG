...
function addQuestBoards(loc) {
    var _a;
    const boards = Object.assign({}, loc.questBoards);
    const ensureBoard = (name, quests) => {
        if (boards[name]) {
    ...
    const banditPatrol = createQuest("Patrol the main road", "Help the guards keep bandits away.", {
    ...
    const prototypeBlade = createQuest("Test prototype blade", "Check with Master Smith before testing.", {
    ...
    ensureBoard("Town Plaza Quest Board", [
    ...
    ensureBoard("Church Quest Board", [
    ...
    ensureBoard("City Gate Quest Board", [
...
const specialist = (count, roles, notes) => makeBand('specialist', count, roles, notes);
const buildQuestBoardMap = (businesses) => {
    const boards = {};
...
const WAVES_BREAK_FARMLAND_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "Largest brick yard on the coast supports Wave's Break, Creekside contracts, and lighthouse maintenance.",
            output: "Cycles six down-draft kilns per tenday (~18,000 bricks) plus roof tiles for urgent repairs.",
        },
        production: {
            goods: ["fired brick", "roof tiles", "pavers"],
            notes: "Contracts prioritize harbor walls, city housing, and outpost beacons; tile runs scheduled between major brick burns.",
        },
        workforce: {
            description: "Continuous kiln operation demands crews for clay extraction, mold filling, firing watches, and sorting.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Stable winds and low humidity allow all kilns to fire simultaneously, demanding extra diggers and relief wardens.",
                staffing: [
            ...
            },
            {
                ...
                description: "Harborworks rushes structural-grade brick orders to rebuild seawalls and tower stairs with strict tolerances.",
                staffing: [
        ...
        quests: [
            createQuest("Kiln-Keeper's Call", "Master Varla Tidemold calls for extra crews to keep every kiln burning through the dry-season run.", {
                ...
                rewardNotes: "Replaces the standard day-labor docket for the burn window with a 25% premium to draw extra crews.",
                postingStyle: "Guild Muster Broadside",
                issuer: "Master Kilner Varla Tidemold",
                replacementFor: "Standard kiln labor docket",
            }),
            createQuest("Stormwall Rebuild Muster", "Harborworks levies emergency crews to turn structural-grade bricks for storm-damaged walls and stairs.", {
                location: "Bayside Brickworks",
                requirements: [
                ...
                rewardNotes: "Supersedes routine maintenance contracts until storm rebuilding quotas are met.",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Supplements city granaries with hardy salt-wind barley while feeding Gate garrisons and caravans.",
        ...
        production: {
            ...
            notes: "Irrigated terraces supply both Wave's Break granaries and contract deliveries to the East Road caravans.",
        },
        workforce: {
        ...
        laborConditions: [
            {
                ...
                description: "Seeds must be set before equinox squalls arrive, requiring every terrace to be planted within six days.",
                staffing: [
            ...
            },
            {
                ...
                description: "Ripened grain must be bound and tarped before equinox storms flatten the terraces.",
                staffing: [
        ...
        quests: [
            createQuest("Saltwind Planters' Levy", "Field-reeve Maera calls for hands to seed the terraces before equinox squalls lash the hillside.", {
                ...
                rewardNotes: "Posting replaces the usual day-hire planting notice with increased pay to lure extra crofters.",
                postingStyle: "Agrarian Levy Notice",
                issuer: "Field-reeve Maera Saltbound",
                replacementFor: "Routine sowing roster",
            }),
            createQuest("Saltwind Reapers' Bounty", "Reapers are needed to bind the crop before gale warnings close the terraces.", {
                location: "Brackenshore Croft",
                requirements: [
                ...
                rewardNotes: "Higher bounty replaces ordinary harvest postings to draw hands from neighboring farms.",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Supplements Mistflower Apiary with cliff-foraged nectar prized by Greensoul alchemists and nobles.",
            output: "Harvests 40 comb crates per season with steep-cliff access crews.",
        },
        production: {
            goods: ["cliff honey", "wax blocks", "royal jelly"],
            notes: "Honey flows to city apothecaries and temple offerings; wax supplied to Candlewrights' Guild.",
        },
        workforce: {
            description: "Cliff hives need rope crews below and bee-masters above to move combs without angering swarms.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "First nectar flow yields delicate combs that must be lifted before wind or gulls ruin them.",
                staffing: [
            ...
            },
            {
                ...
                description: "Boxes shaken loose along the cliff need urgent retrieval to prevent colony loss.",
                staffing: [
        ...
        quests: [
            createQuest("Cliff Nectar Levy", "Honeywardens commission sure-handed climbers to lift the spring combs before gulls strip them bare.", {
            ...
            createQuest("Stormbound Hive Rescue", "Wind-torn hive boxes dangle over the surf and must be winched up before colonies scatter.", {
                location: "Cliffblossom Hives",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Provides cut stone for Wave's Break fortifications, Tidewatcher Lighthouse, and export blocks to Coral Keep.",
            output: "Cuts 24 dressed blocks per day under normal operation, plus rubble aggregate.",
        },
        production: {
            goods: ["cut stone", "aggregate", "lintels"],
            notes: "Stone shipments support harbor seawalls, noble villas, and road paving beyond the city.",
        },
        workforce: {
        ...
        laborConditions: [
            {
                ...
                description: "Orders stack up when the cliff face is safe, requiring additional hammer crews and survey oversight.",
                staffing: [
            ...
            },
            {
                ...
                description: "Replacement blocks for seawalls and breakwaters demand precision cuts with immediate shipping.",
                staffing: [
        ...
        quests: [
            createQuest("Quarry Wedge Charter", "Foreman Brann seeks hammer crews and a master quarryman to free fresh blocks before the next barge.", {
            ...
            createQuest("Harborface Rush Order", "Storm battered the seawall—precision blocks must be cut, numbered, and loaded overnight.", {
                location: "Cliffbreak Quarry",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Signals caravans and fleets, coordinating guard patrols between Wave's Break and the East Road.",
        ...
        production: {
            ...
            notes: "Acts as early-warning hub; dispatch logs feed Gatewatch command and Adventurers' Guild escorts.",
        },
        workforce: {
        ...
        laborConditions: [
            {
                ...
                description: "Fog obscures the coast road; additional runners and veteran watchers ensure caravans depart safely.",
                staffing: [
            ...
            },
            {
                ...
                description: "Beacon must stay lit through squalls while dispatch runners guide coastal villagers to shelter.",
                staffing: [
        ...
        quests: [
            createQuest("Beacon Runner Rotation", "The Gatewatch captain seeks vetted runners and watchers to hold the tower through the spring fog.", {
            ...
            createQuest("Stormsignal Captaincy", "Autumn squalls demand a veteran watch-captain to keep the beacon lit and coordinate evacuations.", {
                location: "Coast Road Watchtower",
                requirements: [
                ...
                rewardNotes: "Supplants routine guard duty roster; only ranked members may accept to avoid subversion risks.",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Primary smithy for the Farmlands refitting plowgear and wagon fittings for Wave's Break and caravan lines.",
        ...
        production: {
            ...
            notes: "Contracts cover farmsteads, Gatewatch patrols, and caravans heading along the East Road.",
        },
        workforce: {
            description: "Apprentices keep bellows and fuel moving while journeymen grind edges and the master balances alloy batches.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Farmsteads flood the forge with dulled plowshares and harrow teeth that must be sharpened before sowing.",
                staffing: [
            ...
            },
            {
                ...
                description: "As harvest sickles dull nightly, the forge runs after dusk to re-edge tools and replace broken fittings.",
                staffing: [
        ...
        quests: [
            createQuest("Forge Bellows Compact", "Smith Barun seeks stout bellows hands and journeymen to refit the Farmlands' tools before sowing.", {
                ...
                rewardNotes: "Supersedes the routine sharpening roster with premium pay to draw extra smiths from city guilds.",
                postingStyle: "Guild Contract Posting",
                issuer: "Smith Barun Copperbrook",
                replacementFor: "Routine tool sharpening queue",
            }),
            createQuest("Nightfall Edge Vigil", "Harvest storms demand overnight crews to keep sickles and wagon fittings battle-ready.", {
                location: "Copperbrook Forge",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Feeds Wave's Break with lamb, wool, and pasture dairy while supplying luminous fiber to city weavers.",
        ...
        production: {
            ...
            notes: "Luminous fleeces contract to Netmaker's Co-op and textile guilds; surplus lamb sold at Tideflock Stockyards.",
        },
        workforce: {
            description: "Shepherd youths mind day rotations while seasoned drovers manage lambing, shearing, and predator patrols.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Night watches ensure safe births and guard against marsh wolves drawn by blood scent.",
                staffing: [
            ...
            },
            {
                ...
                description: "Fleece must be clipped under luminous tides, requiring veteran shearers and careful bundling.",
                staffing: [
        ...
        quests: [
            createQuest("Meadow Drovers' Round", "Steward Elwin needs seasoned drovers and shear teams for the luminous spring clip.", {
                ...
                rewardNotes: "Takes the place of the normal shearer roster with premium rates to secure expert crews.",
                postingStyle: "Pasture Levy Notice",
                issuer: "Steward Elwin Driftfell",
                replacementFor: "Routine shearing roster",
            }),
            createQuest("Nightfall Predator Watch", "Marsh wolves stalk the lambing pens—watch parties must deter them without spooking the flocks.", {
                location: "Driftfell Meadow",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Main overland artery linking Wave's Break to Mountain Top, vital for grain, ore, and caravan security.",
        ...
        production: {
            ...
            notes: "Supports city granary shipments and return caravans carrying ore, silk, and mountain goods.",
        },
        workforce: {
            description: "Teamsters load and drive wagons while outriders scout threats and surveyors monitor road conditions.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Grain convoys depart weekly, requiring extra outriders and loaders to keep schedules tight.",
                staffing: [
            ...
            },
            {
                ...
                description: "Ruts, washouts, and downed trees must be cleared before caravans can safely depart.",
                staffing: [
        ...
        quests: [
            createQuest("East Road Caravan Writ", "Merchants' Exchange charters vetted escorts to see grain wagons safely to Mountain Top.", {
                ...
                rewardNotes: "Supplants the general escort board during convoy weeks to ensure vetted crews are prioritized.",
            ...
            createQuest("Road-Rut Repair Levy", "Road Warden Arel calls for labor crews to mend washouts and fell debris after the last squall.", {
                location: "East Road to Mountain Top",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Only flax fields along the coast feed the Netmaker's Co-op and Threadneedle Hall with linen fiber.",
            output: "Harvests ninety flax bales per season with staggered retting pools.",
        },
        production: {
            goods: ["flax stalks", "retted linen fiber", "flax seeds"],
            notes: "Fiber goes to Netmaker's Co-op and local sailmakers; seeds sold to Harborwind Dairy for feed mixes.",
        },
        workforce: {
            description: "Pullers work barefoot in sandy soil while retting masters tend ponds and combers grade fibers.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Stalks must be pulled and rippled in a four-day window before coastal rains flatten blooms.",
                staffing: [
            ...
            },
            {
                ...
                description: "Retted bundles require constant turning and watch against theft or rot while fermentation runs.",
                staffing: [
        ...
        quests: [
            createQuest("Foamfield Pullers' Call", "Farmholder Deryn seeks nimble crews to pull flax before the sea breeze shifts and ruins the bloom.", {
            ...
            createQuest("Sea Mist Retting Guard", "Rains have filled the retting ponds—experienced tenders must guard and turn the bundles through the night.", {
                location: "Foamfield Flax Farm",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Feeds the city with fresh greens while defending against tides; also supplies pickled stores to garrisons.",
        ...
        production: {
            ...
            notes: "Vegetables supply the Greens Market; levee clay ships to Harborworks for patching coastal defenses.",
        },
        workforce: {
            description: "Weeders, ditch diggers, and levee crews keep water flowing while dike-masters monitor tides.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Sandbagging and clay patches fortify levees before spring tides threaten breaches.",
                staffing: [
            ...
            },
            {
                ...
                description: "Floodgates and drains require round-the-clock monitoring to prevent fields from drowning.",
                staffing: [
        ...
        quests: [
            createQuest("Dike Wardens' Levy", "Reeve Galen summons levee crews to brace the polder against the coming moon tide.", {
            ...
            createQuest("Floodgate Sentinel Call", "Spring rains swell the ditches—sentinels must keep gates clear and sound alarms for breaches.", {
                location: "Greenridge Polder",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces sea-sweetened apples and pears feeding city markets and vintners.",
        ...
        laborConditions: [
            {
                ...
                description: "Fruit ripens quickly in sea mists, requiring swift picking and careful sorting.",
                staffing: [
            ...
            },
            {
                ...
                description: "High winds invite pests and rot; wardens need teams to cull blight and reset scare-lines.",
                staffing: [
        ...
        quests: [
            createQuest("Orchard Scarehand Notice", "Orchard mistress Riala hires sling-armed youths and wardens to gather fruit before gulls strip the boughs.", {
                ...
                rewardNotes: "Posting replaces the standing orchard day-labor call with higher pay for skilled pickers.",
                postingStyle: "Harvest Levy Posting",
                issuer: "Orchard Mistress Riala Seafeather",
                replacementFor: "Standard orchard labor roster",
            }),
            createQuest("Storm-Brushed Graft Patrol", "Post-storm winds leave branches torn and pests prowling—wardens need skilled crews to salvage the crop.", {
                location: "Gulls' Orchard",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Grinds grain for the city and exports flour to Tidehold Granary and outbound caravans.",
            output: "Turns out one hundred twenty sacks of flour per tenday under steady winds.",
        },
        production: {
            goods: ["flour", "bran", "milled feed"],
            notes: "Mills grain from Seabreeze Farm, Brackenshore Croft, and caravan consignments before shipping to the city.",
        },
        workforce: {
            description: "Carriers feed the stones while millers adjust sail cloth and balance gears against sea gusts.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Grain wagons queue nonstop, requiring extra carriers and millwrights to prevent bottlenecks.",
                staffing: [
            ...
            },
            {
                ...
                description: "When wind returns after a calm, mills must run double pace to catch up before grain spoils.",
                staffing: [
        ...
        quests: [
            createQuest("Millstone Rotation Contract", "Miller Joran calls for back-strong carriers and a master to keep the sails turning through the harvest rush.", {
            ...
            createQuest("Windlash Emergency Grind", "After three calm days, wind is back—overnight crews must clear the grain backlog before it sours.", {
                location: "Gullwind Mill",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Supplies Wave's Break with fresh milk, butter, and soft cheeses while exporting salted wheels inland.",
        ...
        production: {
            ...
            notes: "Fresh product sold in city markets; aged cheeses shipped to Sunmellow Grove vintners and caravanserai.",
        },
        workforce: {
            description: "Unskilled milkers and stablehands work dawn shifts while skilled dairymaids churn, culture, and cure cheeses.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Early spring",
                description: "New calves and heavy milk flows require extra hands and watchers through cold dawns.",
                staffing: [
            ...
            },
            {
                ...
                description: "Cheese cellars need vigilant ventilation to prevent mold while salt fog seeps inland.",
                staffing: [
        ...
        quests: [
            createQuest("Dairy Dawn Accord", "Matron Helda offers wages to early-rising milkers and a cheesemaker to keep churns clattering through calving.", {
            ...
            createQuest("Saltfog Cellar Vigil", "Thick fog threatens the curing caves—trusted crews must guard the cheeses from spoilage and thieves.", {
                location: "Harborwind Dairy",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces mist-kissed honey for Greensoul alchemists and temple offerings.",
            output: "Maintains eighty hives yielding fifty casks of honey per season.",
        },
        production: {
            goods: ["honey", "wax", "pollen tinctures"],
            notes: "Honey reserved for temple and apothecary contracts; wax sent to Candlewrights' Guild.",
        },
        workforce: {
            description: "Assistants tend smokers and filters while apiarists manage hives amid dew-laden mornings.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Honey must be pulled at dawn before sun burns off the mist that gives it flavor.",
                staffing: [
            ...
            },
            {
                ...
                description: "Warm nights cause swarms; teams split colonies and capture stray queens.",
                staffing: [
        ...
        quests: [
            createQuest("Mistbee Stewards' Call", "Keeper Lileth seeks gentle-handed apprentices and a master beekeeper to harvest honey without riling the hives.", {
            ...
            createQuest("Swarm-Split Muster", "Summer heat swells the hives—experienced crews must split colonies before they swarm across the fields.", {
                location: "Mistflower Apiary",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Raises phosphorescent goats and wool-fowl whose fibers supply luxury textiles.",
        ...
        production: {
            ...
            notes: "Glow fiber sold to Threadneedle Hall; surplus goats traded through Tideflock Stockyards.",
        },
        workforce: {
            description: "Night shepherds rotate with fiber collectors who clip glowing coats under moonlight.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Fleece glows brightest during specific tides, requiring night crews to shear quickly.",
                staffing: [
            ...
            },
            {
                ...
                description: "Glow attracts predators; night patrols keep herds calm and safe.",
                staffing: [
        ...
        quests: [
            createQuest("Phosphor Herding Scrip", "Herdmaster Vel calls for night watchmen and a spinner to guard and clip the glowing flocks.", {
            ...
            createQuest("Moorlight Ward Patrol", "Reports of marsh cats demand rotating patrols to keep the glowing herds safe.", {
                location: "Moorlight Flats",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Supplies Wave's Break fleet with nets and rope, fulfilling standing orders from the harbor.",
        ...
        production: {
            ...
            notes: "Net patterns tailored for Wave's Break fleets; exports specialty nets to Coral Keep.",
        },
        workforce: {
            description: "Twine combers prep flax while journeymen weave nets on massive frames under guild oversight.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Fleet captains submit orders before sailing season; co-op hires extra hands to meet quotas.",
                staffing: [
            ...
            },
            {
                ...
                description: "Lost nets must be replaced within days; crews work nights to reweave torn sets.",
                staffing: [
        ...
        quests: [
            createQuest("Netwinder Guild Notice", "The co-op offers coin to twine-spinners and a master ropemaker to replace torn nets within seven days.", {
            ...
            createQuest("Storm-Rent Net Rush", "After the gale, half the fleet returned with shredded nets—night crews must reweave replacements immediately.", {
                location: "Netmaker's Co-op",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Primary overland gate controlling Farmlands traffic and caravan flow.",
        ...
        production: {
            ...
            notes: "Serves as checkpoint for incoming goods and muster point for field patrols.",
        },
        workforce: {
            description: "Porters operate winches while guards inspect wagons and manage tolls.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Traffic spikes require additional guards and ledger clerks to process caravans.",
                staffing: [
            ...
            },
            {
                ...
                description: "Gate shifts move to high alert; veteran guards man murder holes and archery slits.",
                staffing: [
        ...
        quests: [
            createQuest("North Gate Roster", "Captain Brisa calls for gate-grinders and a veteran guard to keep the portcullis ready through caravan week.", {
                location: "North Gate",
                requirements: [
            ...
            createQuest("Portcullis Siege Drill", "Intelligence of raiders triggers a siege drill—experienced guards must man the murder holes and test the gate.", {
                location: "North Gate",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces signature coastal wine exported across the kingdom and supplies noble cellars.",
        ...
        production: {
            ...
            notes: "Wines aged for Greensoul salons and exported via Harborwatch; pomace used in Harborwind Dairy feed.",
        },
        workforce: {
            description: "Pickers gather sea-misted grapes while vintners manage pressing, fermentation, and cellar aging.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Grapes must be cut quickly before fog lifts; pressing crews run all day.",
                staffing: [
            ...
            },
            {
                ...
                description: "Cellars risk mildew; trusted staff needed to monitor barrels and ventilation.",
                staffing: [
        ...
        quests: [
            createQuest("Saltcrest Crushing Rite", "Vintner Aelric seeks harvest hands and a cellarer to press grapes before the coastal fog sets in.", {
            ...
            createQuest("Fogguard Cellar Watch", "Persistent fog threatens the barrels—trusted guild members must guard against mildew and theft.", {
                location: "Saltcrest Vineyard & Winery",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Stores grain from Farmlands and caravans, feeding Wave's Break and provisioning fleets.",
            output: "Holds fifteen thousand bushels and cycles shipments daily.",
        },
        production: {
            goods: ["stored grain", "ledger tallies", "grain loans"],
            notes: "Granary maintains emergency reserves and manages grain loans to Harbor Hearth Bakery and the army.",
        },
        workforce: {
            description: "Stackers haul sacks up stilts while stewards track moisture, pests, and inventory.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Wagons queue to unload; extra crews needed to stack and record grain quickly.",
                staffing: [
            ...
            },
            {
                ...
                description: "Raised stilts must be braced and sandbagged; night watches guard against flood seepage.",
                staffing: [
        ...
        quests: [
            createQuest("Granary Stack Oath", "Granary keeper Torv hires ladder-climbing bearers and a grain warden to guard stores against creeping tides.", {
            ...
            createQuest("High Tide Vigil", "Storm tides threaten the granary stilts—night crews must brace supports and monitor seepage.", {
                location: "Saltmarsh Granary",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Supplies Wave's Break with starchy staples and exports salted potatoes to caravanserai.",
            output: "Harvests one hundred fifty wagon loads of potatoes per season.",
        },
        production: {
            goods: ["potatoes", "seed tubers", "gull deterrent paste"],
            notes: "Potatoes feed harbor kitchens; gull deterrent paste sold to neighboring farms.",
        },
        workforce: {
            description: "Diggers lift tubers while skilled wardens manage storage pits and gull deterrents.",
            normal: [
        ...
        laborConditions: [
            {
                trigger: "Harvest dig",
                season: "Late summer to early autumn",
                description: "Tubers must be lifted quickly before gull migrations strip the fields.",
                staffing: [
            ...
            },
            {
                ...
                description: "Extra crews needed to patrol fields, set wards, and protect stored sacks.",
                staffing: [
        ...
        quests: [
            createQuest("Potato Spade Levy", "Farmer Ina calls for hardy spade-hands and a field warden to keep gulls at bay while lifting the crop.", {
            ...
            createQuest("Gull Migration Watch", "The autumn migration begins—trusted crews must patrol fields and guard storage pits day and night.", {
                location: "Saltmeadow Potato Farm",
                requirements: [
                    "Adventurers' Guild Cold Iron rank or Guard Scout stripe",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Provides hardy oats for city stables and caravan beasts; surplus milled at Gullwind Mill.",
            output: "Harvests one hundred ten acres equivalent of oats annually.",
        },
        production: {
            goods: ["oat sheaves", "straw", "seed grain"],
            notes: "Oats delivered to Gullwind Mill and Tideflock Stockyards; straw sold as bedding.",
        },
        workforce: {
            description: "Reapers cut swaying oats while fieldmasters track weather and schedule threshing.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Oats must be cut and stooked before sea gales flatten the crop.",
                staffing: [
            ...
            },
            {
                ...
                description: "Tarp crews guard stooks overnight and rotate watch to prevent losses.",
                staffing: [
        ...
        quests: [
            createQuest("Seabreeze Reaping Bill", "Steward Loran seeks scythe-men and a weatherwise foreman to cut and stook oats ahead of the next gale.", {
            ...
            createQuest("Storm Lash Tarp Crew", "Storm bells ring—oat stacks need tarps held fast through the night to save the crop.", {
                location: "Seabreeze Oat Farm",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces tart plums prized for preserves and medicinal syrups.",
        ...
        laborConditions: [
            {
                ...
                description: "Plums must be clipped gently while mist still clings; surfaces slick.",
                staffing: [
            ...
            },
            {
                ...
                description: "Crews apply herbal washes and clear fungus to save fruit and wood.",
                staffing: [
        ...
        quests: [
            createQuest("Seawisp Fruit Compact", "Orchard keeper Hima calls for light-footed gatherers and a pruner to clip branches amid the sea-mist.", {
            ...
            createQuest("Mildew Ward Sweep", "Prolonged rains demand mildew patrols—apply herbal washes and prune diseased wood before rot spreads.", {
                location: "Seawisp Plum Orchard",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Regulates outbound farm traffic and routes patrols toward the coastal road.",
            output: "Maintains round-the-clock inspections, patrol musters, and toll records for the southern road.",
        },
        production: {
            goods: ["travel permits", "inspection reports", "toll scripts"],
            notes: "Coordinates with Coast Road Watchtower and caravanserai; houses muster for farmland patrols.",
        },
        workforce: {
            description: "Gate aides manage travelers while guards direct wagons and operate the portcullis.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late summer and autumn",
                description: "Hundreds of wagons depart daily; gate requires extra guards to keep order and prevent smuggling.",
                staffing: [
            ...
            },
            {
                ...
                description: "Gate enters lockdown drills requiring veteran squads to muster and escort patrols.",
                staffing: [
        ...
        quests: [
            createQuest("South Gate Writ", "Captain Relwen seeks gate marshals and a sergeant to regulate outbound wagons bound for the fields.", {
                location: "South Gate",
                requirements: [
                    "Wave's Break Guard rank: Gatehand or Adventurers' Guild Bronze",
            ...
            createQuest("Outbound Patrol Escort", "Bandit rumors demand a vetted escort team to lead supply wagons to the outer watchposts.", {
                location: "South Gate",
                requirements: [
                    "Guard rank: Sergeant or Adventurers' Guild Brass",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces stone-warmed fruits and honeyed wine famed in Wave's Break.",
            output: "Harvests seventy terraces of apricots and plums and ferments honeyed wine batches each season.",
        },
        production: {
            goods: ["sunmellow plums", "apricots", "honeyed wine", "fruit cordials"],
            notes: "Honeyed wine sold to Greensoul salons; cordials used by healers and inns.",
        },
        workforce: {
            description: "Pickers handle delicate fruits while vintners monitor fermenting vats in sun-warmed cellars.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Fruits ripen under stone terraces; picking must avoid overheating and bruising.",
                staffing: [
            ...
            },
            {
                ...
                description: "Honeyed wine ferments can overheat; crews rotate to stir and cool vats.",
                staffing: [
        ...
        quests: [
            createQuest("Sunmellow Vintage Bid", "Grove mistress Lysa hires fruit-pluckers and a vintner to ferment honeyed wine before the sweetness fades.", {
            ...
            createQuest("Stone Heat Shade Crew", "Heat waves threaten the vats—trusted crews must rig shadecloth and cool fermenters through the hottest nights.", {
                location: "Sunmellow Grove",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Markets cattle and sheep for Wave's Break and exports to Creekside and Coral Keep.",
            output: "Processes five hundred head weekly with auctions and drives.",
        },
        production: {
            goods: ["livestock sales", "ledger tallies", "wool bales"],
            notes: "Handles drover contracts and quarantine pens; coordinates with Driftfell Meadow and Moorlight Flats.",
        },
        workforce: {
            description: "Muckers clean pens while drovers manage auctions, quarantine, and shipment counts.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Large consignments require extra pen hands and drovers to manage bidding and shipments.",
                staffing: [
            ...
            },
            {
                ...
                description: "Herds must be moved to higher ground quickly; requires experienced drovers and handlers.",
                staffing: [
        ...
        quests: [
            createQuest("Stockyard Muster", "Drovers' guild seeks yard hands and a tallyman to manage incoming herds this market week.", {
            ...
            createQuest("Storm Herd Relocation", "Storm surge threatens the low pens—experienced drovers must move herds to high shelter overnight.", {
                location: "Tideflock Stockyards",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Guides ships, warns of storms, and coordinates coastal evacuations.",
            output: "Maintains beacon, lens polishing, and dispatch watch at all hours.",
        },
        production: {
            goods: ["beacon light", "weather reports", "dispatches"],
            notes: "Signals Harborworks, Coast Road Watchtower, and shoreline hamlets; houses the storm bells.",
        },
        workforce: {
            description: "Assistants haul oil and polish lenses while watchmen observe sea lanes and signal towers.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Beacon must stay lit through gale-force winds; extra crews secure ropes and sound bells.",
                staffing: [
            ...
            },
            {
                ...
                description: "Practice evacuation signals and foghorn relays for villages along the coast.",
                staffing: [
        ...
        quests: [
            createQuest("Tidewatch Beacon Order", "Keeper Malen seeks oil-haulers and a veteran watcher to keep vigil through brewing storms.", {
            ...
            createQuest("Fogline Evacuation Drill", "Spring fog demands a full drill—signal crews must coordinate lighthouse, watchtower, and coastal hamlets.", {
                location: "Tidewatcher Lighthouse",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Harnesses tidal surges to grind grain when windmills stall.",
            output: "Grinds eighty sacks per tide cycle and supplements Gullwind Mill production.",
        },
        production: {
            goods: ["flour", "bran", "coarse meal"],
            notes: "Handles wet grain shipments after storms; requires precise timing with tides.",
        },
        workforce: {
            description: "Carriers load grain onto tidal platforms while millers align gears to incoming waves.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring tides",
                description: "High tides provide extra power; crews extend hours to mill backlog.",
                staffing: [
            ...
            },
            {
                ...
                season: "After major storms",
                description: "Gears need inspection and cleaning to remove debris; requires skilled millwrights.",
                staffing: [
        ...
        quests: [
            createQuest("Tidewheel Miller's Bond", "Millwright Jessa hires grain porters and a tide-savvy miller to grind through the spring run-off.", {
            ...
            createQuest("Storm Surge Gear Lock", "Storm debris jammed the gears—skilled crews must disassemble, clean, and reset before the next tide.", {
                location: "Tidewheel Watermill",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Finishes stone blocks from Cliffbreak Quarry for city projects and noble commissions.",
        ...
        production: {
            ...
            notes: "Supplies Governor's Keep, harbor balustrades, and exports carved fascia to Coral Keep.",
        },
        workforce: {
            description: "Apprentices sand blocks while master masons chisel ornamental faces.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Large commissions require extra apprentices and masters to meet deadlines.",
                staffing: [
            ...
            },
            {
                ...
                season: "After coastal storms",
                description: "Damaged harbor facades need replacements; stoneworks run extended shifts.",
                staffing: [
        ...
        quests: [
            createQuest("Stoneworks Apprentice Call", "Guild seeks block-turners and a master mason to finish the governor's commission.", {
            ...
            createQuest("Harbor Facade Rush", "Storm damage requires intricate stone replacements—only vetted masons may carve replacements overnight.", {
                location: "Wavecut Stoneworks",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Produces berry wines for export and local festivals; hillside requires sure-footed crews.",
            output: "Harvests sixty berry terraces and ferments sparkling berry wine batches.",
        },
        production: {
            goods: ["berries", "berry wine", "cordials"],
            notes: "Exports sparkling berry wine to nobles; leftover berries sold fresh in markets.",
        },
        workforce: {
            description: "Pickers navigate steep slopes while vintners manage fermenting vats susceptible to hill gusts.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Berries must be picked before winds bruise them; crews need safety ropes.",
                staffing: [
            ...
            },
            {
                ...
                description: "Gusts cool vats unevenly; crews stir and warm fermentation to keep flavor consistent.",
                staffing: [
        ...
        quests: [
            createQuest("Windward Wine Writ", "Vintner Soren invites berry-pickers and a fermenter to keep vats singing despite the hill's gusts.", {
            ...
            createQuest("Gustborn Ferment Guard", "Storm gusts chill the vats—skilled crews must stabilize fermentation through the night.", {
                location: "Windward Berry Vineyard & Winery",
                requirements: [
...
const WAVES_BREAK_FARMLAND_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_FARMLAND_BUSINESSES);
const WAVES_BREAK_PORT_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "Bonded warehouses and city customs rely on Harborwatch to clear every cargo that reaches the quay.",
            output: "Stamped manifests, customs seals, bonded vault space, and routed wagons to inland buyers.",
        },
        production: {
            goods: ["bonded manifests", "customs seals", "vault allocations"],
            notes: "Handles high-value cargo for nobles and merchants; smaller houses rent counter space for oversight.",
        },
        workforce: {
            description: "Ledger halls, bonded vaults, and the seal court require runners, clerks, and auditors around the clock.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Merchants flood the counters after the tidal festivals, demanding more clerks and vault oversight.",
                staffing: [
                    skilled(6, "temporary tally clerks and oath-bond notaries"),
                    specialist(2, "bond auditors to inspect gem coffers and spice chests", "Paid directly by the magistrate for accuracy."),
                ],
            },
            {
                trigger: "Storm-delayed flotillas arriving at once",
                season: "Any storm season emergency",
                description: "Backlogged ships arrive in a single tide, requiring night crews to clear perishable cargo.",
                staffing: [
        ...
        quests: [
            createQuest("Harborwatch Ledger Levy", "Factor Merina seeks trustworthy hands to balance manifests while convoys queue in the tidefog.", {
            ...
            createQuest("Seal Court Contraband Sweep", "The magistrate commands a midnight audit of suspicious cargo holds rumored to hide smuggled aetherglass.", {
                location: "Harborwatch Trading House",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Stormkeel manages the largest slipways on the coast, repairing the fleet and laying keels for royal commissions.",
            output: "Ocean-going hulls, mast assemblies, and deep-keel retrofits for naval cutters and merchant carracks.",
        },
        production: {
            goods: ["repaired hull sections", "fresh masts", "tarred decking"],
            notes: "Maintains three drydocks simultaneously while apprentices craft fittings and spars in adjoining sheds.",
        },
        workforce: {
            description: "Massive slipways demand haulers for timber, journeymen to true ribs, and masters to sign off on keels.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "The fleet limps home with sprung planks, calling for extra patch crews to strip and recaulk overnight.",
                staffing: [
            ...
            },
            {
                ...
                description: "When the crown orders a new deepwater keel, extra masters supervise round-the-clock lofting.",
                staffing: [
        ...
        quests: [
            createQuest("Stormwake Hull Patch Crew", "Stormkeel calls for steady saw-hands to strip tarred planks and sister ribs before the fleet sails again.", {
            ...
            createQuest("Deep Keel Reliability Bond", "The Admiralty requires trusted artisans to oversee a deep-keel commission bound for royal waters.", {
                location: "Stormkeel Shipwrights",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The naval yard arms the cutters guarding the coast and drills marines that protect the sea lanes.",
            output: "Ready patrol crews, armed cutters, and signal coverage for the bay.",
        },
        production: {
            goods: ["armed patrols", "signal lantern coverage", "ready powder stores"],
            notes: "Maintains three ready cutters and rotates marines for convoy escort and lighthouse relief duties.",
        },
        workforce: {
            description: "Sail lofts, powder magazines, and signal towers rely on porters, marines, and mage-wardens.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Signals blur in heavy fog; extra watchers and runners keep beacons lit and cutters alert.",
                staffing: [
            ...
            },
            {
                ...
                description: "When corsair flags are reported, the yard doubles readiness and calls for trusted auxiliaries.",
                staffing: [
        ...
        quests: [
            createQuest("Fog Ward Night Patrol", "Captain Yorsen needs vigilant eyes to keep the beacon line unbroken through the harbor fog.", {
            ...
            createQuest("Corsair Response Drill", "Admiral's orders call for veteran blades to drill boarding actions against suspected corsairs.", {
                location: "Harbor Guard Naval Yard",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The salt pans of Wave's Break supply the fleet, markets, and inland caravans with preserved sea-salt.",
            output: "Coarse sea salt, fine finishing salt, and concentrated brine for pickling.",
        },
        production: {
            goods: ["coarse salt", "fine salt", "brine concentrate"],
            notes: "Brine channels feed tiered pans; kiln sheds refine the finest crystals for noble tables.",
        },
        workforce: {
            description: "Evaporation pans rely on scrapers, kiln keepers, and testers to keep shipments pure.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Brine dries swiftly, demanding extra crews to rake crystals before winds scatter them.",
                staffing: [
            ...
            },
            {
                ...
                season: "Autumn storm season",
                description: "Brine fouled by storm debris requires testers and barrel crews to salvage usable stock.",
                staffing: [
        ...
        quests: [
            createQuest("Tide-Salt Harvest Hands", "Saltmaster Rinna hires hardy scrapers to clear drying pans before the noon gusts scatter the crystals.", {
                location: "Saltworks",
                requirements: [
            ...
            createQuest("Crystal Purity Inquest", "Noble tables demand flawless crystals; trusted tasters must certify each batch after the storm surge.", {
                location: "Saltworks",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Fishmongers' Row handles the city's daily catch and supplies inland caravans with preserved stock.",
            output: "Iced fish crates, smoked delicacies, and salted cuts bound for markets.",
        },
        production: {
            goods: ["fresh fish", "smoked fish", "salted fillets"],
            notes: "Cooling sheds, smoking pits, and auction stages keep the catch moving before it spoils.",
        },
        workforce: {
            description: "Gut lines, auction blocks, and smokehouses demand tireless haulers, careful graders, and master tasters.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring thaw",
                description: "Boats return overloaded, requiring extra gutting crews before sunrise markets.",
                staffing: [
            ...
            },
            {
                ...
                description: "Highborn feasts and warships demand impeccable cuts and secure delivery.",
                staffing: [
        ...
        quests: [
            createQuest("Dawn Gutting Line", "The dockmasters need quick hands before the sun spoils the herring glut.", {
            ...
            createQuest("Rare Catch Auction Steward", "A leviathan tuna must be divided and escorted to the Upper Ward without scandal.", {
                location: "Fishmongers' Row",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The Ropewalk spins hemp for every ship in Wave's Break and exports towlines along the coast.",
            output: "Hemp rope coils, tarred towing lines, and mooring cables sized to navy spec.",
        },
        production: {
            goods: ["hemp rope", "tarred towlines", "naval mooring cables"],
            notes: "Hemp is combed, spun, and tarred along a hundred-yard hall under watchful gauge masters.",
        },
        workforce: {
            description: "Long halls of spinning hemp rely on twisters, tar stirrers, and gauge masters to meet naval contracts.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Fleet captains demand fresh towlines before storms, stretching crews thin.",
                staffing: [
            ...
            },
            {
                ...
                description: "Royal inspectors require masters to certify gauge, forcing extra proofing crews to work the line.",
                staffing: [
        ...
        quests: [
            createQuest("Storm Towline Rush", "Rope-master Galen seeks deft hands to spin storm towlines before the fleet departs.", {
            ...
            createQuest("Admiralty Cable Commission", "Royal inspectors demand flawless mooring cables for a flagship refit.", {
                location: "The Ropewalk",
                requirements: [
...
const WAVES_BREAK_PORT_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_PORT_BUSINESSES);
const WAVES_BREAK_UPPER_WARD_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "Governor's Keep houses the council, treasury vaults, and elite guard command that safeguard the city.",
            output: "Council edicts, secured vault inventories, and strategic directives for guard deployments.",
        },
        production: {
            goods: ["sealed decrees", "treasury oversight", "guard rotations"],
            notes: "Vault stewards, heralds, and spymasters coordinate from the keep; trusted auxiliaries are rare.",
        },
        workforce: {
            description: "Pages, scribes, bodyguards, and ward-mages labor side-by-side to protect the keep's secrets.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "The council convenes to set taxes or war policy, demanding additional escorts and scribes to record decrees.",
                staffing: [
            ...
            },
            {
                ...
                description: "When envoys arrive, the keep requires cultural interpreters and discreet escorts through the Upper Ward.",
                staffing: [
        ...
        quests: [
            createQuest("State Courier Escort", "The governor seeks discreet blades to carry sealed dispatches through the Upper Ward and out along the royal road.", {
            ...
            createQuest("Vault Seal Audit", "Treasury provosts require impartial witnesses to confirm the warding of the governor's vaults after an attempted breach.", {
                location: "Governor's Keep",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The Hall of Records maintains deeds, taxes, and treaties for the city and the crown.",
            output: "Certified ledgers, archival copies, and scholarly access to historic writs.",
        },
        production: {
            goods: ["archival transcripts", "tax tallies", "sealed deeds"],
            notes: "Scribes and archivists file every transaction; only trusted hands touch noble ledgers.",
        },
        workforce: {
            description: "The archive operates on precise schedules with scribes, catalogers, and preservationists.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late winter",
                description: "Tax rolls arrive from every district, requiring additional clerks and night readers.",
                staffing: [
            ...
            },
            {
                ...
                description: "Property losses must be logged swiftly to release relief funds, demanding trusted scribes.",
                staffing: [
        ...
        quests: [
            createQuest("Archive Sifting Vigil", "Chief Archivist Rellis requests discreet assistants to index noble ledgers delivered after dusk.", {
            ...
            createQuest("Edict Copyist Circle", "Royal writs must be copied overnight for the Dawn Court; only steady calligraphers need apply.", {
                location: "Hall of Records",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The exchange clears letters of credit, specie transfers, and bulk commodity contracts for nobles and guilds.",
            output: "Certified letters of credit, guarded bullion transfers, and market intelligence bulletins.",
        },
        production: {
            goods: ["letters of credit", "bullion vaulting", "market reports"],
            notes: "Factors, guards, and auditors handle fortunes each day; missteps ruin reputations instantly.",
        },
        workforce: {
            description: "The exchange relies on runner-pages, floor clerks, bullion guards, and senior factors.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late autumn",
                description: "Grain contracts flood the exchange, requiring additional brokers and guard escorts for specie wagons.",
                staffing: [
            ...
            },
            {
                ...
                description: "When fraud is suspected, the exchange assembles trusted investigators to trail suspects discreetly.",
                staffing: [
        ...
        quests: [
            createQuest("Specie Transfer Escort", "High Factors require steel to move a vault of silver through the Upper Ward at midnight.", {
            ...
            createQuest("Market Manipulator Sting", "Exchange tribunes suspect a noble syndicate of fixing salt prices and request covert proof.", {
                location: "Mercantile Exchange",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The guildhall cuts noble gems, fashions regalia, and certifies jewels traded across the kingdom.",
            output: "Cut gemstones, gilded regalia, and certification seals recognized by the crown.",
        },
        production: {
            goods: ["cut gems", "ornate regalia", "gem certificates"],
            notes: "Lapidarists, engravers, and enchant-smiths work in sealed ateliers under constant guard.",
        },
        workforce: {
            description: "The guild employs apprentices for polishing, journeymen for settings, and masters for royal commissions.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "When the crown demands regalia, the guild operates day and night with master oversight.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "If thieves strike, the hall calls for trusted guards and gemwrights to verify no stones were switched.",
                staffing: [
        ...
        quests: [
            createQuest("Gemcutting Vigil", "Master Jeweler Serapha requires deft hands to polish fire opals while guildmasters certify each facet.", {
            ...
            createQuest("Vaulted Regalia Escort", "A coronation diadem must reach the Governor's Keep under heavy guard.", {
                location: "Master Jeweler's Guildhall",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The salon curates vintages for the noble terraces and arranges expeditions for rare coastal grapes.",
            output: "Curated vintages, pairing banquets, and noble wine contracts.",
        },
        production: {
            goods: ["reserve vintages", "pairing menus", "wine contracts"],
            notes: "Sommeliers and stewards maintain cellars, while contracted adventurers secure rare harvests.",
        },
        workforce: {
            description: "Cellar hands, sommeliers, and banquet stewards labor to satisfy noble palates.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "High summer",
                description: "Grand banquets require extra stewards and tasters to guard against spoilage or poison.",
                staffing: [
            ...
            },
            {
                ...
                description: "Sea cliffs produce rare grapes under moonlight; the salon hires trusted crews to harvest before gulls arrive.",
                staffing: [
        ...
        quests: [
            createQuest("Reserve Vintage Steward", "The salon requires quiet attendants to manage a noble tasting without alerting rival houses.", {
            ...
            createQuest("Moonlit Cloudberry Expedition", "A rare cloudberry patch ripens atop cliffside terraces; the salon funds a guarded harvest.", {
                location: "Highward Vintners' Salon",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The apothecarium distills rare essences for nobles and supplies refined alchemical reagents to the court.",
            output: "Distilled perfumes, restorative draughts, and alchemical essences for the governor's table.",
        },
        production: {
            goods: ["perfumed essences", "restorative draughts", "alchemical distillates"],
            notes: "Perfumiers and alchemists share kiln rooms; mishaps can sour entire cellars.",
        },
        workforce: {
            description: "Still-wardens, essence blenders, and alchemical scribes coordinate delicate distillations.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Early summer",
                description: "Nobles demand bespoke scents, requiring overtime distillations and trusted testers.",
                staffing: [
            ...
            },
            {
                ...
                season: "Emergency",
                description: "Restorative draughts must be brewed under quarantine protocols; only vetted alchemists admitted.",
                staffing: [
        ...
        quests: [
            createQuest("Essence Distillation Vigil", "Mistress Aurelia invites patient assistants to tend midnight distillations while the salon prepares festival orders.", {
            ...
            createQuest("Dreamblossom Procurement", "A noble heir requires dreamblossom petals harvested from mist-clad terraces beyond the Upper Ward.", {
                location: "Aurelian Apothecarium & Perfumery",
                requirements: [
...
const WAVES_BREAK_UPPER_WARD_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_UPPER_WARD_BUSINESSES);
const WAVES_BREAK_LITTLE_TERNS_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "The Guild of Smiths supplies arms, tools, and city infrastructure with mastercrafted metalwork.",
            output: "Weapons, armor, agricultural tools, and architectural fittings for Wave's Break and beyond.",
        },
        production: {
            goods: ["weapons", "armor", "tools"],
            notes: "Forge halls run around the clock; apprentices pump bellows while masters temper contracts for nobles and the guard.",
        },
        workforce: {
            description: "Bellows crews, journeyman smiths, and master temperers toil in heat and sparks throughout Little Terns.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late winter",
                description: "The guard refits arms before spring patrols, requiring overtime temper lines and hafting crews.",
                staffing: [
            ...
            },
            {
                ...
                description: "Nobles demand ceremonial armor and filigreed steel, calling for master temperers and engravers.",
                staffing: [
        ...
        quests: [
            createQuest("Forge Coal Rush", "The guild needs sturdy backs to keep the furnaces hot while new guard spears are drawn.", {
            ...
            createQuest("Masterwork Temper Vigil", "Master Hadrin calls for proven artisans to oversee tempering of a ceremonial blade for the Upper Ward.", {
                location: "Guild of Smiths",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The carpenters frame homes, wagons, and ship interiors for Wave's Break and inland caravans.",
            output: "Framed structures, wagon bodies, and custom cabinetry for trade ships.",
        },
        production: {
            goods: ["timber frames", "wagons", "cabinetry"],
            notes: "Sawyers, joiners, and finishers keep the yards humming as guild masters bid on major contracts.",
        },
        workforce: {
            description: "Fresh timbers arrive daily; crews plane beams, set joints, and finish cabinetry for the city's demands.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring",
                description: "New families settle near the walls, requiring extra framing crews and scaffolders.",
                staffing: [
            ...
            },
            {
                ...
                season: "Late summer",
                description: "Caravaners order reinforced wagons for the autumn push, requiring trusted carpenters and wheelwrights.",
                staffing: [
        ...
        quests: [
            createQuest("Rafter Loft Assembly", "Guildmistress Tella seeks agile carpenters to loft rafters for a new guildhouse wing.", {
            ...
            createQuest("Royal Coach Commission", "The governor ordered a gilded coach; the guild needs veterans to oversee joinery and finish.", {
                location: "Timberwave Carpenters' Guild",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The hall fashions bows, arrows, and carved works for hunters, guards, and nobles.",
            output: "Longbows, crossbow stocks, hunting arrows, and carved ornaments.",
        },
        production: {
            goods: ["bows", "arrows", "carved ornamentation"],
            notes: "Seasoned yew and hardwoods are cured in special lofts; fletchers work in shifts to meet guard quotas.",
        },
        workforce: {
            description: "Woodcarvers, fletchers, and finishing artists share the hall, each bound by strict guild quotas.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late spring",
                description: "City guard demands arrow stockpiles before the caravan season, requiring double shifts.",
                staffing: [
            ...
            },
            {
                ...
                season: "Autumn",
                description: "Nobles order fine bows and carved gifts, calling for master artisans and discreet security.",
                staffing: [
        ...
        quests: [
            createQuest("Arrow Rush Muster", "Fletcher foremen hire rapid hands to finish a guard arrow requisition before the caravan muster.", {
            ...
            createQuest("Starlit Bow Commission", "A noble house requests a rune-etched bow; the hall needs trusted artisans to oversee the work.", {
                location: "Carvers' and Fletchers' Hall",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The Gilded Needle outfits nobles and affluent merchants, employing dozens of seamstresses and tailors.",
            output: "Custom garments, courtly attire, and ceremonial robes.",
        },
        production: {
            goods: ["formalwear", "court robes", "tailored uniforms"],
            notes: "Tailors work by appointment; cloth from across the world flows through the atelier.",
        },
        workforce: {
            description: "Pattern cutters, stitchers, and embroiderers craft garments to precise noble specifications.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Autumn",
                description: "Nobles reorder entire wardrobes ahead of court openings, requiring overnight fitting circles.",
                staffing: [
            ...
            },
            {
                ...
                season: "Spring",
                description: "Parades and pageants demand elaborate costumes, calling for textile masters and dye mages.",
                staffing: [
        ...
        quests: [
            createQuest("Festival Wardrobe Hands", "Mistress Seraphine requires nimble fingers to finish festival wardrobes before the banners are unfurled.", {
            ...
            createQuest("Silk Wardens", "A royal envoy demands secure transport of rare silks from the docks to the atelier.", {
                location: "The Gilded Needle Clothiers",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The tannery processes hides for armorers, saddlers, and sailmakers across Wave's Break.",
            output: "Tanned leather, oiled hides, and specialty treated pelts.",
        },
        production: {
            goods: ["tanned leather", "saddlery hides", "treated pelts"],
            notes: "Soaking pits, bark barrels, and drying lofts operate in careful sequence to avoid spoilage.",
        },
        workforce: {
            description: "Pit workers, curriers, and finishers labor amid pungent fumes to deliver high-grade leather.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Wet markets flood the tannery with raw hides that must be processed quickly to avoid rot.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Nobles order supple leathers for finery, requiring master finishers and secure storage.",
                staffing: [
        ...
        quests: [
            createQuest("Hide Soak Rotation", "Tannery steward Pell hires hardy hands to keep pits stirred during a surge of storm-wet hides.", {
            ...
            createQuest("Royal Leather Curation", "The governor's household requests supple leather; the tannery needs trusted curriers to finish and guard the shipment.", {
                location: "Brine & Bark Tannery",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The hall weaves and stitches sails for the harbor fleet, merchant ships, and naval contracts.",
            output: "Square sails, storm canvas, and custom pennants sized for the fleet.",
        },
        production: {
            goods: ["sails", "storm canvas", "naval pennants"],
            notes: "Lofts stretch cloth across long tables; crews work in shifts to meet tidal launch schedules.",
        },
        workforce: {
            description: "Sailcloth carders, stitchers, and rigging testers labor in the cooperative to keep the fleet supplied.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Autumn storms",
                description: "Damaged sails pour in after gales, demanding overtime stitching and tar sealing.",
                staffing: [
            ...
            },
            {
                ...
                season: "Quarterly",
                description: "Royal inspectors demand precise gauge; gauge masters and testers must certify each sail.",
                staffing: [
        ...
        quests: [
            createQuest("Storm Sail Menders", "The cooperative calls for deft stitchers to mend storm-torn sails before the fleet departs again.", {
            ...
            createQuest("Admiralty Canvas Commission", "Royal contracts demand flawless storm canvas; the cooperative seeks veteran artisans to oversee quality.", {
                location: "Seawind Sailmakers' Hall",
                requirements: [
...
const WAVES_BREAK_LITTLE_TERNS_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_LITTLE_TERNS_BUSINESSES);
const WAVES_BREAK_GREENSOUL_HILL_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "The Grand Library collects tomes from across the realm, training sages and preserving lore for the crown.",
            output: "Curated archives, research assistance, and scholarly treatises for the city and visiting mages.",
        },
        production: {
            goods: ["archived tomes", "research notes", "cataloged scrolls"],
            notes: "Copyists, lorekeepers, and custodians maintain the stacks; rare collections require constant vigilance.",
        },
        workforce: {
            description: "Scribes, loremasters, and preservationists care for fragile tomes while guiding scholars through the stacks.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Visiting scholars flood the stacks, requiring extra guides and preservationists to protect fragile works.",
                staffing: [
            ...
            },
            {
                ...
                season: "Autumn storms",
                description: "Water-damaged books need drying and restoration under the eye of master preservers.",
                staffing: [
        ...
        quests: [
            createQuest("Restricted Stack Vigil", "Head Archivist Ilvara requests quiet guardians to monitor scholars within the sealed stacks.", {
            ...
            createQuest("Lost Tome Retrieval", "An ancient ledger vanished into the catacombs beneath the stacks; trusted explorers must recover it.", {
                location: "Grand Library of Wave's Break",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The enclave trains battle-mages, researches wards, and supports the city's magical defenses.",
            output: "Spell research, defensive wards, and trained arcanists for the governor and guilds.",
        },
        production: {
            goods: ["spell diagrams", "protective wards", "magical treatises"],
            notes: "Circle masters oversee apprentices in rune halls; any miscast can threaten the district.",
        },
        workforce: {
            description: "Apprentices, journeyman mages, and circle masters collaborate on rituals and magical research.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Shifting leylines demand extra warders and watchers to stabilize protective spells.",
                staffing: [
            ...
            },
            {
                ...
                description: "Visiting mages attempt experimental summons, requiring containment specialists and scribes.",
                staffing: [
        ...
        quests: [
            createQuest("Sigil Stabilization Circle", "Archmage Selene needs deft casters to reinforce a faltering ward before the next ley surge.", {
            ...
            createQuest("Ley Survey Expedition", "Surveyors must chart new ley currents beyond the city; the enclave seeks mages with steady nerves.", {
                location: "Arcanists' Enclave",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The conservatory cultivates rare herbs for healers, alchemists, and temple rites.",
            output: "Medicinal herbs, ritual components, and botanical research.",
        },
        production: {
            goods: ["healing herbs", "ritual flowers", "botanical studies"],
            notes: "Glasshouse keepers regulate humidity and light; plague scares require disciplined staff.",
        },
        workforce: {
            description: "Gardeners, herbalists, and druidic wardens tend delicate plants and safeguard sacred seeds.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "High summer",
                description: "Glasshouses overheat, demanding extra water crews and shade wardens.",
                staffing: [
            ...
            },
            {
                ...
                season: "Early autumn",
                description: "Moonblossoms bloom for one night, requiring trusted harvesters and druid wardens.",
                staffing: [
        ...
        quests: [
            createQuest("Greenhouse Steward Watch", "Conservator Mera seeks patient gardeners to rotate damp cloths and shade frames during the heatwave.", {
            ...
            createQuest("Moonblossom Harvest", "The druids need calm hands to harvest moonblossoms for temple rites before dawn.", {
                location: "Herbal Conservatory",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Skyline trains scribes, diplomats, and fledgling mages who serve the city's bureaucracy and trade houses.",
            output: "Educated graduates, public lectures, and civic examinations.",
        },
        production: {
            goods: ["tutoring", "public lectures", "examination certificates"],
            notes: "Professors hold classes from dawn to dusk; exam weeks require extra proctors and hall monitors.",
        },
        workforce: {
            description: "Professors, tutors, and administrators shepherd cohorts of students from across the realm.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late spring",
                description: "Hundreds sit for civic exams, requiring proctors and scribes to prevent cheating.",
                staffing: [
            ...
            },
            {
                ...
                season: "Midwinter",
                description: "Traveling sages host lectures, requiring ushers and note-takers to capture knowledge.",
                staffing: [
                    unskilled(6, "ushers"),
        ...
        quests: [
            createQuest("Exam Hall Proctors", "Dean Callus hires impartial wardens to oversee civic examinations and stamp candidate scrolls.", {
            ...
            createQuest("Scholars' Escort", "Foreign lecturers require discreet escort between Skyline Academy and Greensoul hostels.", {
                location: "Skyline Academy",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The Temple of the Tides tends to sailors, blesses fleets, and safeguards sacred relics for the city.",
            output: "Religious services, tidal blessings, and sanctuary for the faithful.",
        },
        production: {
            goods: ["blessings", "healing rites", "tidal relic care"],
            notes: "Clergy conduct dawn and dusk rites; reliquaries require trusted guardians.",
        },
        workforce: {
            description: "Acolytes, choristers, and clerics manage rituals while temple guards protect the sanctum.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring tide",
                description: "Crowds gather for blessings, requiring extra stewards and guards to manage offerings.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Sacred relics move between sanctums, demanding trusted escorts and relic wardens.",
                staffing: [
        ...
        quests: [
            createQuest("Procession Wardens", "High Priestess Maela seeks calm guardians to marshal tideblessing crowds and guard donation chests.", {
            ...
            createQuest("Relic Vigil", "A relic must be moved to the Upper Ward; the temple requires stalwart escorts under solemn oath.", {
                location: "Temple of the Tides",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The guild crafts candles for temples, nobles, and arcane rituals, blending waxcraft with alchemical dyes.",
            output: "Temple candles, arcane tapers, and perfumed lights for the city.",
        },
        production: {
            goods: ["ritual candles", "perfumed tapers", "lantern wax"],
            notes: "Wax kettles and dye vats run day and night; precision ensures no ritual misfires.",
        },
        workforce: {
            description: "Wax stirrers, mold setters, and dye specialists work in shifts to keep the city's lights burning.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Midwinter",
                description: "Every household orders candles, demanding overtime casters and dye workers.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Arcanists require precise tapers for rituals, needing specialist oversight and warded storage.",
                staffing: [
        ...
        quests: [
            createQuest("Festival Candle Run", "Guildmaster Oren needs trustworthy runners to monitor vats and deliver festival batches on time.", {
            ...
            createQuest("Arcane Taper Oversight", "Arcanists commissioned glyph-bound tapers; the guild needs veteran candlewrights to oversee casting.", {
                location: "Candlewrights' Guild",
                requirements: [
...
const WAVES_BREAK_GREENSOUL_HILL_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_GREENSOUL_HILL_BUSINESSES);
const WAVES_BREAK_LOWER_GARDENS_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "Quayside Greens supplies fresh produce to the city and passing caravans, coordinating dozens of stalls.",
            output: "Fresh vegetables, herbs, and daily market stalls for locals and travelers.",
        },
        production: {
            goods: ["fresh produce", "market services", "stall rentals"],
            notes: "Market stewards balance stall assignments, security, and sanitation amid daily crowds.",
        },
        workforce: {
            description: "Porters, hawkers, and stewards keep the market orderly while vendors rotate goods at dawn.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late summer and autumn",
                description: "Farm carts overflow with produce, requiring extra porters and tally clerks to prevent spoilage.",
                staffing: [
            ...
            },
            {
                ...
                description: "Crowds pack the market; security and trash crews must double shifts to keep order.",
                staffing: [
        ...
        quests: [
            createQuest("Market Dawn Porters", "Steward Jessa hires reliable porters to unload dawn carts and keep the aisles clear.", {
            ...
            createQuest("Festival Stall Marshals", "Festival crowds demand extra marshals to keep lanes open and settle disputes.", {
                location: "Quayside Greens Market",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "South Gate Market serves caravans heading inland, blending warehousing with street trade.",
            output: "Travel provisions, caravan contracts, and warehousing services.",
        },
        production: {
            goods: ["provisions", "contract brokerage", "warehouse slots"],
            notes: "Porters, brokers, and guards coordinate caravans leaving the city each day.",
        },
        workforce: {
            description: "Caravan brokers, porters, and gate guards coordinate schedules to keep caravans moving.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late summer",
                description: "Long trade columns depart, requiring extra loaders and manifest inspectors.",
                staffing: [
            ...
            },
            {
                ...
                description: "Gate security doubles shifts, calling for trusted guards to vet travelers.",
                staffing: [
        ...
        quests: [
            createQuest("Caravan Loader Levy", "Gate sergeants hire loaders to ready caravans before the midday sun.", {
            ...
            createQuest("Manifest Inspection Patrol", "Smuggling rumors demand discreet inspectors to walk the line and verify manifests at dusk.", {
                location: "South Gate Market",
                requirements: [
                    "Investigation 20+",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The arena hosts contests, gladiatorial exhibitions, and festivals requiring extensive staff and security.",
            output: "Spectator events, gladiator bouts, and festival spectacles.",
        },
        production: {
            goods: ["entertainment", "security", "vendor space"],
            notes: "Arena crews manage crowds, schedule performers, and pay gladiators.",
        },
        workforce: {
            description: "Stagehands, healers, and guards keep the arena safe while spectacles unfold.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Tournament crowds fill the stands, demanding extra ushers and medics.",
                staffing: [
                    unskilled(10, "ushers"),
            ...
            },
            {
                ...
                season: "At need",
                description: "Exotic beasts and mages require specialist handlers and security.",
                staffing: [
        ...
        quests: [
            createQuest("Arena Crowd Marshals", "Arena master Garen needs marshals to keep crowds orderly during champion bouts.", {
            ...
            createQuest("Champion Escort", "The arena hires trusted blades to escort visiting champions through festival crowds.", {
                location: "Seastone Arena",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The pavilion hosts concerts, plays, and noble gatherings requiring staff skilled in etiquette and staging.",
            output: "Performances, receptions, and cultural galas for Wave's Break.",
        },
        production: {
            goods: ["performances", "receptions", "noble hospitality"],
            notes: "Musicians, stage crew, and stewards coordinate to impress visiting nobles and patrons.",
        },
        workforce: {
            description: "Performers, stagehands, and stewards ensure events run smoothly for discerning audiences.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Court season",
                description: "High-profile events require extra rehearsals and security.",
                staffing: [
                    skilled(8, "musicians"),
            ...
            },
            {
                ...
                season: "Summer",
                description: "Crowded galas need additional stewards and servers to manage noble guests.",
                staffing: [
                    skilled(10, "stewards"),
        ...
        quests: [
            createQuest("Evening Attendance Marshal", "Maestro Neral hires poised attendants to usher nobles and manage seating charts.", {
            ...
            createQuest("Noble Gala Wardens", "The pavilion seeks discreet guards to manage private salons during a noble gala.", {
                location: "Wisteria Pavilion",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The brewery supplies ale to the Lower Gardens and noble terraces, experimenting with unique coastal flavors.",
            output: "Cask ales, festival brews, and specialty taproom service.",
        },
        production: {
            goods: ["ales", "festival brews", "taproom service"],
            notes: "Brewmasters oversee fermentation while coopers manage cask cellars.",
        },
        workforce: {
            description: "Mash stirrers, coopers, and taproom staff keep ale flowing for revelers and festivals.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Festivals demand seasonal brews, requiring extra mash crews and cooperages.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Brewmasters dispatch trusted adventurers to fetch rare herbs or yeasts from the marsh.",
                staffing: [
        ...
        quests: [
            createQuest("Brew House Night Shift", "Brewmaster Tolen hires assistants to tend mash tuns and keep temperatures steady through the night.", {
            ...
            createQuest("Rare Malt Procurement", "The brewery seeks seasoned adventurers to retrieve brine-malt from misty marsh mounds.", {
                location: "Anchor's Toast Brewery",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The Sunleaf Inn hosts travelers, merchants, and festival performers, offering refined hospitality.",
            output: "Lodging, banquets, and concierge services for affluent guests.",
        },
        production: {
            goods: ["lodging", "banquets", "concierge services"],
            notes: "Innkeepers coordinate kitchens, performers, and security for visiting dignitaries.",
        },
        workforce: {
            description: "Hosts, servers, and security staff keep guests comfortable and protected.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                description: "Full bookings require extra staff for cleaning and banquets.",
                staffing: [
            ...
            },
            {
                ...
                season: "Court season",
                description: "High-ranked guests demand dedicated attendants and security.",
                staffing: [
        ...
        quests: [
            createQuest("Guest Suite Stewards", "Innkeeper Lysa seeks discrete attendants to manage noble suites during festival season.", {
            ...
            createQuest("Night Terrace Wardens", "The inn hires trusted guards to patrol the terrace suites housing foreign envoys.", {
                location: "Sunleaf Inn",
                requirements: [
...
const WAVES_BREAK_LOWER_GARDENS_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_LOWER_GARDENS_BUSINESSES);
const WAVES_BREAK_HIGH_ROAD_BUSINESSES = [
    {
        ...
        scale: {
            ...
            rationale: "The guildhall coordinates contracts, training, and dispatches for adventurers across the region.",
            output: "Contract postings, guild services, and training oversight for members.",
        },
        production: {
            goods: ["contracts", "training", "guild arbitration"],
            notes: "Clerks process tokens and ranks; instructors brief parties before departures.",
        },
        workforce: {
            description: "Scribes, quartermasters, and officers coordinate guild operations and maintain dormitories for members.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring",
                description: "Contracts flood in after winter, requiring extra clerks and training officers to process parties.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "When emergencies strike, the guild needs marshals to coordinate rapid deployments.",
                staffing: [
        ...
        quests: [
            createQuest("Guild Gate Stewards", "Guildmaster Ryn requests trusted members to monitor the token desk and verify returning parties.", {
            ...
            createQuest("Emergency Dispatch Marshal", "The guildhall seeks veteran members to coordinate response teams during crises.", {
                location: "Adventurers' Guildhall",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Coachworks construct and repair carriages for merchants and nobility preparing for road journeys.",
            output: "Coaches, wagon refits, and wheel repairs for caravans.",
        },
        production: {
            goods: ["coaches", "wagons", "wheel assemblies"],
            notes: "Wheelwrights and harness makers share the yard; guild contracts demand precise workmanship.",
        },
        workforce: {
            description: "Wheelwrights, harness makers, and carpenters outfit caravans departing the High Road District.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring and autumn",
                description: "Caravans refit wagons before long journeys, requiring extra wheelwrights and harness makers.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Noble orders for luxury coaches demand master oversight and night security.",
                staffing: [
        ...
        quests: [
            createQuest("Wheelwright Night Shift", "Foreman Darel seeks steady hands to true wheels overnight before caravans depart.", {
            ...
            createQuest("Royal Coach Escort", "A newly built coach must be delivered to the Upper Ward; the yard needs trusted escorts.", {
                location: "Rolling Wave Coachworks",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The guild crafts harnesses, saddles, and armor pieces for caravans and city guard units.",
            output: "Harness sets, saddles, leather armor, and travel gear.",
        },
        production: {
            goods: ["harnesses", "saddles", "leather armor"],
            notes: "Curriers, stitchers, and armorers share the guild hall, processing hides from the Tannery.",
        },
        workforce: {
            description: "Leatherworkers cut, stitch, and oil harnesses while armorers craft travel-ready gear for guild contracts.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring",
                description: "Caravans order harness replacements before long routes, requiring overtime stitchers.",
                staffing: [
            ...
            },
            {
                ...
                season: "Autumn",
                description: "City guard orders new leathers, demanding master armorers and quality inspectors.",
                staffing: [
                    skilled(6, "armorers"),
        ...
        quests: [
            createQuest("Harness Stitch Rotation", "Guildmaster Pell requests quick stitchers to finish caravan harness orders overnight.", {
            ...
            createQuest("Guard Leathers Inspection", "The guard contracts require trusted artisans to inspect and certify new armor batches.", {
                location: "Wavehide Leather Guild",
                requirements: [
                    "Leatherworking proficiency 26+",
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "Armsmiths in the High Road District forge weapons and shields for caravans and mercenary companies.",
            output: "Polearms, shields, and caravan weapon refits.",
        },
        production: {
            goods: ["spearheads", "shields", "maintenance kits"],
            notes: "The cooperative focuses on field-ready arms, coordinating with the Guild of Smiths for supply.",
        },
        workforce: {
            description: "Forge crews harden spearheads, assemble shields, and prepare maintenance kits for road use.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Spring and autumn",
                description: "Caravan guards demand fresh arms, requiring extended forging shifts.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "When bandit raids spike, the cooperative produces emergency batches of shields and spearheads.",
                staffing: [
        ...
        quests: [
            createQuest("Shield Press Assistants", "Shieldwrights need extra press hands to rivet shield rims before caravans depart.", {
            ...
            createQuest("Emergency Arms Drill", "Master Sella drills volunteer smiths to forge emergency spearheads during bandit alerts.", {
                location: "Shield & Sail Armsmiths",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The barracks house the Gatewatch who protect caravans, inspect travelers, and respond to countryside threats.",
            output: "Guard patrols, gate security, and caravan escorts.",
        },
        production: {
            goods: ["guard patrols", "inspection services", "escort details"],
            notes: "Sentries rotate through watchtowers while officers coordinate patrol routes with the Adventurers' Guild.",
        },
        workforce: {
            description: "Guards, trackers, and signal officers maintain readiness along the High Road.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "At need",
                description: "Bandit reports increase patrols, requiring extra guards and trackers.",
                staffing: [
                    skilled(12, "guards"),
            ...
            },
            {
                ...
                season: "Spring",
                description: "Large caravans require additional escorts beyond the city walls.",
                staffing: [
        ...
        quests: [
            createQuest("Gatewatch Patrol Muster", "Captain Ilyan calls for reliable blades to ride night patrols along the High Road.", {
            ...
            createQuest("Escort Captain Detail", "Gatewatch seeks veteran adventurers to lead caravan escort detachments during the busy season.", {
                location: "Gatewatch Barracks",
                requirements: [
    ...
    },
    {
        ...
        scale: {
            ...
            rationale: "The caravanserai houses merchants, beasts, and guards preparing for long journeys.",
            output: "Lodging for caravans, stockyards, and maintenance services.",
        },
        production: {
            goods: ["caravan lodging", "beast care", "caravan provisioning"],
            notes: "Stablemasters, cooks, and scribes coordinate dozens of caravans each tenday.",
        },
        workforce: {
            description: "Stable hands tend beasts while stewards manage contracts and quartermasters supply caravans.",
            normal: [
        ...
        laborConditions: [
            {
                ...
                season: "Late summer",
                description: "Multiple caravans overlap, requiring extra hands to feed beasts and prepare barracks.",
                staffing: [
            ...
            },
            {
                ...
                season: "At need",
                description: "Illness among beasts demands specialized handlers and healers.",
                staffing: [
                    skilled(6, "beast handlers"),
        ...
        quests: [
            createQuest("Stable Night Rotation", "Caravanserai steward Nyla hires night crews to feed and calm restless caravan beasts.", {
            ...
            createQuest("Caravan Factor Escort", "A wealthy factor needs discreet escort to deliver contracts to the Adventurers' Guild and Gatewatch.", {
                location: "Stonebridge Caravanserai",
                requirements: [
...
const WAVES_BREAK_HIGH_ROAD_QUEST_BOARDS = buildQuestBoardMap(WAVES_BREAK_HIGH_ROAD_BUSINESSES);
const WAVES_BREAK_DISTRICT_BUSINESSES = {
...
const WAVES_BREAK_DISTRICT_QUEST_BOARDS = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, WAVES_BREAK_PORT_QUEST_BOARDS), WAVES_BREAK_UPPER_WARD_QUEST_BOARDS), WAVES_BREAK_LITTLE_TERNS_QUEST_BOARDS), WAVES_BREAK_GREENSOUL_HILL_QUEST_BOARDS), WAVES_BREAK_LOWER_GARDENS_QUEST_BOARDS), WAVES_BREAK_HIGH_ROAD_QUEST_BOARDS), WAVES_BREAK_FARMLAND_QUEST_BOARDS);
const WAVES_BREAK_BUSINESSES = Object.values(WAVES_BREAK_DISTRICT_BUSINESSES).reduce((acc, list) => acc.concat(list), []);
...
Its people are diverse: salt-stained sailors, silver-tongued merchants, hammer-armed crafters, scroll-burdened sages, and faith-driven priests. The city thrives on motion—goods, people, and ideas all collide here, leaving behind a place of markets, temples, shrines, and secrets.`)), { subdivisions: [
    ...
    }, businesses: WAVES_BREAK_BUSINESSES, questBoards: Object.assign({}, WAVES_BREAK_DISTRICT_QUEST_BOARDS) });
...
Coral Keep is also a city of exchange. Caravans arrive from the lumber-rich highlands to the west, where massive timbers are harvested for beams, keels, and great halls. From here they are loaded onto ships bound for the eastern cities, while imported spices, silks, and gems are offloaded in return. Sister to Wave's Break, Coral Keep mirrors its counterpart's importance, but with a sharper focus on luxury goods and refined crafts. It is a city of opportunity and danger—its Northern Slums hide thieves and smugglers, while its Forge District hums with industry, and its Old City holds both forgotten shrines and the bustling markets of centuries past.`)), { subdivisions: [
        ...
        districts: {
            ...
            "Greywind's Edge": {
                estimate: 1600,
                notes: "warehouses, caravanserai, stables, guard outposts",
            },
            "Starrise Shade": {
                estimate: 3000,
                notes: "middling merchants, scholars, priests, scribes, herb gardens",
            },
            "Fairy Hook": {
                estimate: 1500,
                notes: "fisherfolk, sailors, wavefront shrines",
            },
        },
        hinterland: {
            estimate: 6500,
            notes: "farmsteads, lumber camps, and quarries; plus 600-900 overnight non-residents, 1,000-1,200 daily visitors, and festival peaks of up to 5,000 outside the walls",
        },
    }, pointsOfInterest: {
        buildings: [
            "The Coral Citadel",
...
The town also carries a reputation for healing and quiet retreat. Many ailing nobles, merchants, or adventurers have made the difficult journey up the mountain passes to bathe in the steaming springs or to consult with the elite alchemists who call Warm Springs home. Though some rumors exaggerate the miraculous properties of the waters, there is truth to their restorative effects. The town, however, has little to offer in the way of excitement—quests are few, dangers minimal, and most contracts are low-risk tasks taken by locals or beginner adventurers. As a result, Warm Springs remains small and insulated, self-sufficient in food but reliant on Creekside for goods such as textiles, tools, and bottles. Its rare fish and shellfish, prized for their vivid colors, exquisite flavors, and alchemical uses, are yet another treasure hidden in this quiet mountain basin.`)), { subdivisions: [
        ...
        "Riverfront",
        "Farms and Orchards",
    ], travel: { routes: ["mountain path to Creekside"], connections: ["Creekside"] }, pointsOfInterest: {
        buildings: [
...
export const LOCATIONS = {
    "Duvilia Kingdom": createLocation("Duvilia Kingdom", "Duvilia Kingdom.png", `Duvilia Kingdom – Realm of Coast and Crown
