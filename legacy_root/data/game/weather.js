...
const HIGHLAND_WOODLAND_CLIMATE = {
  temperature: {
...
const GEOTHERMAL_MOUNTAIN_CLIMATE = {
  temperature: {
...
const GEOTHERMAL_FARMLAND_CLIMATE = {
  temperature: {
...
const GEOTHERMAL_RIVER_CLIMATE = {
  temperature: {
...
const SUBALPINE_WOODLAND_CLIMATE = {
  temperature: {
...
const SUBALPINE_MOUNTAIN_CLIMATE = {
  temperature: {
...
const PLATEAU_MOUNTAIN_CLIMATE = {
  temperature: {
...
const PLATEAU_FARMLAND_CLIMATE = {
  temperature: {
...
const HEARTLAND_FARMLAND_CLIMATE = {
  temperature: {
...
const FRONTIER_WOODLAND_CLIMATE = {
  temperature: {
...
const FRONTIER_FARMLAND_CLIMATE = {
  temperature: {
...
export const CORAL_KEEP_REGION_CLIMATE = {
  key: 'coral_keep',
...
export const TIMBER_GROVE_REGION_CLIMATE = {
  key: 'timber_grove',
...
export const CREEKSIDE_REGION_CLIMATE = {
  key: 'creekside',
...
export const WARM_SPRINGS_REGION_CLIMATE = {
  key: 'warm_springs',
...
export const DANCING_PINES_REGION_CLIMATE = {
  key: 'dancing_pines',
...
export const MOUNTAIN_TOP_REGION_CLIMATE = {
  key: 'mountain_top',
...
export const CORONA_REGION_CLIMATE = {
  key: 'corona',
...
export const CORNER_STONE_REGION_CLIMATE = {
  key: 'corner_stone',
...
export const DRAGONS_REACH_ROAD_REGION_CLIMATE = {
...
export const WHITEHEART_REGION_CLIMATE = {
  key: 'whiteheart',
