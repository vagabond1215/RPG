...
export function renderBackstoryString(template, context = {}) {
  ...
  const replacements = {
    ...
    "{hook}": context.hook || "",
    "{hookDetail}": context.hookDetail || context.hook_detail || "",
    "{districtFlair}": context.districtFlair || context.district_flair || "",
    "{disciplineTag}": context.disciplineTag || context.discipline_tag || "",
