...
const ENVIRONMENT_NODES = [
  {
    ...
    actions: {
      ...
      dive: {
        ...
        questMinigame: {
          title: 'Plan Your Dive',
          intro: 'Before you slip beneath the tide, decide how you want to brave the breakers.',
          choices: [
            {
              key: 'survey',
              label: 'Survey the currents',
              detail: 'Study the tides and mark hazards, trading time for a steadier haul.',
              chanceBonus: 0.12,
              eventChanceBonus: 0.1,
              timeRangeMultiplier: 1.25,
              narrative:
                'You wade waist deep, watching the surge and silt until the rhythm of the current makes sense.',
              resultNote: 'You planned the dive by charting the shifting currents first.',
            },
            {
              key: 'plunge',
              label: 'Plunge between waves',
              detail: 'Time the sets and get in fast. Less time below, higher risk, and a chance at lost salvage.',
              chanceBonus: -0.08,
              eventChanceBonus: 0.05,
              timeRangeMultiplier: 0.8,
              narrative: 'You count the breakers and launch yourself in a heartbeat of calm water.',
              resultNote: 'You dove on a fast break, chasing quick treasure before the waves closed in.',
              addRandomEvents: [
                {
                  weight: 1,
                  scene: 'A burst of foam reveals a splintered chest wedged beneath a piling.',
                  outcome: 'Inside you find a pouch of dull-green coins that polish back to a shine.',
                  loot: [
                    {
                      name: 'Wave-Claimed Coin Pouch',
                      category: 'Treasure',
                      qtyRange: [1, 1],
                      baseItem: 'Coin Pouch',
                    },
            ...
            {
              key: 'partner',
              label: 'Partner with a dockhand',
              detail: 'Split the dive with a seasoned local to balance risk and reward.',
              chanceBonus: 0.05,
              eventChanceBonus: 0.12,
              timeRangeMultiplier: 1.05,
              narrative: 'You team up with a wharf diver who knows every piling by touch and rumor.',
              resultNote: 'You coordinated with a local diver to share the dive and the finds.',
              addRandomEvents: [
                {
                  weight: 1,
                  scene: 'Your partner taps a hidden crevice where shellfish cling.',
                  outcome: 'Together you free a cluster of oysters heavy with pearls.',
                  loot: [
                    {
                      name: 'Shared Pearl Cache',
                      category: 'Gemstones',
                      qtyRange: [1, 2],
                      baseItem: 'Pearl',
                    },
      ...
      swim: {
        ...
        questMinigame: {
          title: 'Choose Your Swim',
          intro: 'The breakers roar. Decide how you want to tackle the surf.',
          choices: [
            {
              key: 'steady',
              label: 'Set a steady rhythm',
              detail: 'Keep to a measured pace that lets you read the waves as you go.',
              chanceBonus: 0.08,
              eventChanceBonus: 0.1,
              timeRangeMultiplier: 1.1,
              narrative: 'You find an even cadence, matching strokes to the rise and fall of each swell.',
              resultNote: 'You held a deliberate pace, letting the tide set your rhythm.',
            },
            {
              key: 'sprint',
              label: 'Sprint the line',
              detail: 'Dash through the surf for a quick workout—less time, more strain, bigger payoff if successful.',
              chanceBonus: -0.06,
              eventChanceBonus: 0.05,
              timeRangeMultiplier: 0.75,
              narrative: 'You explode through each breaker, trusting speed over caution.',
              resultNote: 'You chose a sprint through the breakers, muscles burning from the effort.',
              addRandomEvents: [
                {
                  weight: 1,
                  scene: 'A powerful surge knocks you sideways into a calm eddy.',
                  outcome: 'Catching your breath there leaves you energized despite the sudden detour.',
                },
              ],
            },
            {
              key: 'drift',
              label: 'Drift with the swells',
              detail: 'Float and glide, letting the sea carry you. Slower, but restorative.',
              chanceBonus: 0.04,
              eventChanceBonus: 0.12,
              timeRangeMultiplier: 1.3,
              narrative: 'You surrender to the push and pull, conserving energy as you ride each swell inward.',
              resultNote: 'You drifted with the breakers, savoring the sea breeze.',
            },
          ],
        },
      },
