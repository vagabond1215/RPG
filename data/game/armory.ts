...
export const ARMORY: Record<string, WeaponRecord[]> = {
  swords: [
    ...
    { name: "Sawtooth Falx (Underrealm Set)", region: "Underrealm", size: "Large", hands: 2, reach: "Medium/Long", description: "Night-etched falx with recurved serrations and a chain-wrapped haft that anchors into armor seams; forged for underrealm vanguards.", fightingStyle: "Hooked drag cuts followed by crushing finishers", attackSpeed: 5.2, damage: 8.4, armorPen: "High", specialEffect: "Lacerating cuts inflict lingering bleed", quality: "Masterwork", priceCp: 5200, priceDisplay: "2g 12si", descriptionFull: "Sawtooth Falx (Underrealm Set). Night-etched falx with recurved serrations and a chain-wrapped haft that anchors into armor seams; forged for underrealm vanguards. Its lacerating hooks leave lingering bleed that punishes staggered foes while the reinforced haft drives home brutal finishing blows." },
