...
export function canTrain(trainer, learner) {
...
export const TRAINERS = [
    ...
    { craft: 'glassblowing', tier: 'journeyman', name: 'Jorin Sandshaper', city: 'Coral Keep', location: "Glassblowing Trainer's Workshop" },
    { craft: 'blacksmithing', tier: 'journeyman', name: 'Brakka Ironbent', city: "Wave's Break", location: "Smithing Trainer's Forge" },
    { craft: 'carpentry', tier: 'journeyman', name: 'Tella Woodhand', city: "Wave's Break", location: "Carpentry Trainer's Lodge" },
    { craft: 'tailoring', tier: 'apprentice', name: 'Nimble Nia', city: "Wave's Break", location: "Tailoring Trainer's Shop" },
    { craft: 'leatherworking', tier: 'apprentice', name: 'Pell the Tanner', city: "Wave's Break", location: "Leatherworking Trainer's Shed" },
    { craft: 'alchemy', tier: 'journeyman', name: 'Iris Flaskbinder', city: "Wave's Break", location: "Alchemy Trainer's Lab" },
    { craft: 'enchanting', tier: 'initiate', name: 'Sira Glowtouch', city: "Wave's Break", location: "Enchanting Trainer's Sanctum" },
    { craft: 'pearl-diving', tier: 'journeyman', name: 'Doran Deepbreath', city: 'Coral Keep', location: "Pearl Diving Trainer's Dock" },
];
